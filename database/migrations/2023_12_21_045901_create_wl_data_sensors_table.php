...
return new class extends Migration
{
    ...
    {
        Schema::create('wl_data_sensors', function (Blueprint $table) {
            $table->id();
            $table->unsignedBigInteger('sensor_id');
            $table->foreign('sensor_id')->references('id')->on('wl_sensors')->onDelete('cascade')->onUpdate('cascade');
            ...
            $table->string('level_mdpl')->nullable();
    ...
    {
        Schema::dropIfExists('wl_data_sensors');
    }
};
